...
benchmark "hipaa_164_312_d" {
  title         = "164.312(d)"
  #documentation = file("./hipaa/docs/hipaa_164_312_d.md")
  children = [
    control.hipaa_164_312_d_iam_account_password_policy_strong_min_resuse_24,
    control.hipaa_164_312_d_iam_user_mfa_all,
    control.hipaa_164_312_d_iam_user_mfa,
...
control "hipaa_164_312_d_iam_account_password_policy_strong_min_resuse_24" {
  ...
  #documentation = file("./hipaa/docs/hipaa_1164_312_d_iam_account_password_policy_strong_min_resuse_24.md")

  tags = merge(local.hipaa_164_312_d_common_tags, {
    hipaa_item_id  = "hipaa_164_312_d_iam_account_password_policy_strong_min_resuse_24"
  })
}
...
control "hipaa_164_312_d_iam_user_mfa_all" {
  ...
  sql           = query.iam_user_mfa_all.sql
  #documentation = file("./hipaa/docs/hipaa_1164_312_d_iam_user_mfa_all.md")

  tags = merge(local.hipaa_164_312_d_common_tags, {
    hipaa_item_id  = "hipaa_164_312_d_iam_user_mfa_all"
  })
}
...
control "hipaa_164_312_d_iam_user_mfa" {
  ...
  #documentation = file("./hipaa/docs/hipaa_1164_312_d_iam_user_mfa.md")

  tags = merge(local.hipaa_164_312_d_common_tags, {
    hipaa_item_id  = "hipaa_164_312_d_iam_user_mfa"
  })
}
...
control "hipaa_164_312_d_iam_root_user_hardware_mfa" {
  ...
  #documentation = file("./hipaa/docs/hipaa_1164_312_d_iam_root_user_hardware_mfa.md")

  tags = merge(local.hipaa_164_312_d_common_tags, {
    hipaa_item_id  = "hipaa_164_312_d_iam_root_user_hardware_mfa"
  })
}
...
control "hipaa_164_312_d_iam_root_user_mfa" {
  ...
  #documentation = file("./hipaa/docs/hipaa_1164_312_d_iam_root_user_mfa.md")

  tags = merge(local.hipaa_164_312_d_common_tags, {
    hipaa_item_id  = "hipaa_164_312_d_iam_root_user_mfa"
  })
}