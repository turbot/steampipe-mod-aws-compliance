locals {
  control_tower_ebs_checks_common_tags = merge(local.control_tower_common_tags, {
...
benchmark "control_tower_ebs_checks" {
  ...
  children = [
    benchmark.control_tower_ebs_checks_1_0_1,
    benchmark.control_tower_ebs_checks_1_0_2,
    benchmark.control_tower_ebs_checks_1_0_3,
  ]
  tags          = local.control_tower_ebs_checks_common_tags
}
...
benchmark "control_tower_ebs_checks_1_0_1" {
  ...
  tags = merge(local.control_tower_ebs_checks_common_tags, {
    control_tower_item_id  = "1.0.1"
  })
}
