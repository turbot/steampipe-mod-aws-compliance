...
benchmark "cis_v100_5" {
  ...
  children = [
    ...
    control.cis_v100_5_7,
    control.cis_v100_5_8,
    control.cis_v100_5_9,
    control.cis_v100_5_10
  ]
...
control "cis_v100_5_7" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_5_7.md")
...
control "cis_v100_5_9" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_5_9.md")
...
control "cis_v100_5_10" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_5_10.md")
