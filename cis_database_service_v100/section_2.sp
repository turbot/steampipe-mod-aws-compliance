locals {
  cis_database_service_v100_2_common_tags = merge(local.cis_database_service_v100_common_tags, {
    cis_section_id = "2"
  })
}
...
benchmark "cis_database_service_v100_2" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2.md")
  children = [
    control.cis_database_service_v100_2_1,
    control.cis_database_service_v100_2_2,
    control.cis_database_service_v100_2_3,
    control.cis_database_service_v100_2_4,
    control.cis_database_service_v100_2_5,
    control.cis_database_service_v100_2_6,
    control.cis_database_service_v100_2_7,
    control.cis_database_service_v100_2_8,
    control.cis_database_service_v100_2_9,
    control.cis_database_service_v100_2_10,
    control.cis_database_service_v100_2_11
  ]

  tags = merge(local.cis_database_service_v100_2_common_tags, {
    type = "Benchmark"
  })
}
...
control "cis_database_service_v100_2_1" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_1.md")
...
control "cis_database_service_v100_2_2" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_2.md")
...
control "cis_database_service_v100_2_3" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_3.md")
...
control "cis_database_service_v100_2_4" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_4.md")
...
control "cis_database_service_v100_2_5" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_5.md")
...
control "cis_database_service_v100_2_6" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_6.md")
...
control "cis_database_service_v100_2_7" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_7.md")
...
control "cis_database_service_v100_2_8" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_8.md")
...
control "cis_database_service_v100_2_9" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_9.md")
...
control "cis_database_service_v100_2_10" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_10.md")
...
control "cis_database_service_v100_2_11" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_2_11.md")
