...
benchmark "cis_v100_9" {
  ...
  children = [
    ...
    control.cis_v100_9_2,
    control.cis_v100_9_9,
    control.cis_v100_9_9,
    control.cis_v100_9_5,
    control.cis_v100_9_6,
    control.cis_v100_9_7
  ]
...
control "cis_v100_9_2" {
  ...
  documentation = file("./cis_v100/docs/cis_v100_9_2.md")
...
control "cis_v100_9_3" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_9_3.md")
...
control "cis_v100_9_4" {
  ...
  documentation = file("./cis_v100/docs/cis_v100_9_4.md")
...
control "cis_v100_9_5" {
  ...
  documentation = file("./cis_v100/docs/cis_v100_9_5.md")
...
control "cis_v100_9_6" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_9_6.md")
...
control "cis_v100_9_7" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v100/docs/cis_v100_9_7.md")
