locals {
  cis_database_service_v100_3_common_tags = merge(local.cis_database_service_v100_common_tags, {
    cis_section_id = "3"
  })
}
...
benchmark "cis_database_service_v100_3" {
  title         = "3 Amazon RDS"
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3.md")
  children = [
    control.cis_database_service_v100_3_1,
    control.cis_database_service_v100_3_2,
    control.cis_database_service_v100_3_3,
    control.cis_database_service_v100_3_4,
    control.cis_database_service_v100_3_5,
    control.cis_database_service_v100_3_6,
    control.cis_database_service_v100_3_7,
    control.cis_database_service_v100_3_8,
    control.cis_database_service_v100_3_9,
    control.cis_database_service_v100_3_10,
    control.cis_database_service_v100_3_11
  ]

  tags = merge(local.cis_database_service_v100_3_common_tags, {
    type = "Benchmark"
  })
}
...
control "cis_database_service_v100_3_1" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_1.md")
...
control "cis_database_service_v100_3_2" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_2.md")
...
control "cis_database_service_v100_3_3" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_3.md")
...
control "cis_database_service_v100_3_4" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_4.md")
...
control "cis_database_service_v100_3_5" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_5.md")
...
control "cis_database_service_v100_3_6" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_6.md")
...
control "cis_database_service_v100_3_7" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_7.md")
...
control "cis_database_service_v100_3_8" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_8.md")
...
control "cis_database_service_v100_3_9" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_9.md")
...
control "cis_database_service_v100_3_10" {
  ...
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_10.md")
...
control "cis_database_service_v100_3_11" {
  ...
  query         = query.manual_control
  documentation = file("./cis_database_service_v100/docs/cis_database_service_v100_3_11.md")
