...
benchmark "cis_v600_3_1" {
  title         = "3.1 Simple Storage Service (S3)"
  documentation = file("./cis_v600/docs/cis_v600_3_1.md")
  children = [
    control.cis_v600_3_1_1,
    control.cis_v600_3_1_2,
    control.cis_v600_3_1_3,
...
benchmark "cis_v600_3_2" {
  title         = "3.2 Relational Database Service (RDS)"
  documentation = file("./cis_v600/docs/cis_v600_3_2.md")
  children = [
    control.cis_v600_3_2_1,
    control.cis_v600_3_2_2,
    control.cis_v600_3_2_3,
...
benchmark "cis_v600_3_3" {
  title         = "3.3 Elastic File System (EFS)"
  documentation = file("./cis_v600/docs/cis_v600_3_3.md")
  children = [
...
control "cis_v600_3_1_2" {
  title         = "3.1.2 Ensure MFA Delete is enabled on S3 buckets"
...
control "cis_v600_3_1_3" {
  title         = "3.1.3 Ensure all data in Amazon S3 has been discovered, classified, and secured when necessary"
...
control "cis_v600_3_1_4" {
  title         = "3.1.4 Ensure that S3 is configured with 'Block Public Access' enabled"
...
control "cis_v600_3_2_1" {
  title         = "3.2.1 Ensure that encryption-at-rest is enabled for RDS instances"
...
control "cis_v600_3_2_2" {
  title         = "3.2.2 Ensure the Auto Minor Version Upgrade feature is enabled for RDS instances"
...
control "cis_v600_3_2_3" {
  title         = "3.2.3 Ensure that RDS instances are not publicly accessible"
...
control "cis_v600_3_3_1" {
  title         = "3.3.1 Ensure that encryption is enabled for EFS file systems"
  description   = "Encryption should be enabled for EFS file systems."
