...
benchmark "nist_800_53_rev_5_si_2_c" {
  title       = "SI-2(c)"
  description = "c. Install security-relevant software and firmware updates within [Assignment: organization-defined time period] of the release of the updates;"
  children = [
    control.elastic_beanstalk_enhanced_health_reporting_enabled,
    control.redshift_cluster_maintenance_settings_check,
    control.ssm_managed_instance_compliance_patch_compliant,
...
benchmark "nist_800_53_rev_5_si_2_d" {
  title       = "SI-2(d)"
  description = "d. Incorporate flaw remediation into the organizational configuration management process."
  children = [
    control.elastic_beanstalk_enhanced_health_reporting_enabled,
    control.redshift_cluster_maintenance_settings_check,
    control.ssm_managed_instance_compliance_patch_compliant,
