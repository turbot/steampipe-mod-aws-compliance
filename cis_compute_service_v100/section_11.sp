locals {
  cis_compute_service_v110_11_common_tags = merge(local.cis_compute_service_v110_common_tags, {
    cis_section_id = "11"
  })
}

benchmark "cis_compute_service_v110_11" {
  ...
  documentation = file("./cis_compute_service_v110/docs/cis_compute_service_v110_11.md")
  children = [
    control.cis_compute_service_v110_11_1
  ]

  tags = merge(local.cis_compute_service_v110_11_common_tags, {
    type = "Benchmark"
  })
}
...
control "cis_compute_service_v110_11_1" {
  ...
  documentation = file("./cis_compute_service_v110/docs/cis_compute_service_v110_11_1.md")
