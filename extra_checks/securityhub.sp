...
benchmark "extra_checks_securityhub" {
  title       = "SecurityHub"
  description = "This benchmark contains additional checks for AWS SecurityHub servcice, these checks are out of the scope of any predefined benchmarks for AWS."
  children = [
