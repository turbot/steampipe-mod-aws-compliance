...
benchmark "extra_checks_cloudfront" {
  title       = "CloudFront"
  description = "This benchmark contains additional checks for AWS CloudFront service, these checks are out of the scope of any predefined benchmarks for AWS."
  children = [
