...
benchmark "extra_checks_cloudformation" {
  ...
  description = "This benchmark contains additional checks for AWS CloudFormation service, these checks are out of the scope of any predefined benchmarks for AWS."
  children = [
