...
control "redshift_cluster_enhanced_vpc_routing_enabled" {
  ...
  description = "Ensure if AWS Redshift cluster has 'enhancedVpcRouting' enabled. The rule is non  compliant if 'enhancedVpcRouting' is not enabled or if the configuration.enhancedVpcRouting field is 'false'."
