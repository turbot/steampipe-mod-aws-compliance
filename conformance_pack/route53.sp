...
control "route53_domain_expires_30_days" {
  title       = "Route 53 Domain Name should not expire within next 30 days"
...
control "route53_domain_expires_7_days" {
  title       = "Route 53 Domain Name should not expire within next 7 days"
...
control "route53_domain_not_expired" {
  title       = "Route 53 Domain Names should not be expired"
